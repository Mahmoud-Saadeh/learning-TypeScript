...
if (root2) {
  var user_1 = User_1.User.buildUser({
    name: 'Mahmoud',
    age: 23
  });
  var userEdit = new UserEdit_1.UserEdit(root2, user_1);
  user_1.on('change', function () {
    console.log(user_1);
  });
  userEdit.render();
  user_1.save();
...
users.fetch();
},{"./views/UserList":"src/views/UserList.ts","./models/Collection":"src/models/Collection.ts","./models/User":"src/models/User.ts","./views/UserEdit":"src/views/UserEdit.ts"}],"../../.nvm/versions/node/v14.17.6/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../.nvm/versions/node/v14.17.6/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
